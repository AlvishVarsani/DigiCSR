...
class _BenificiaryLogin extends State<BenificiaryLogin> {
  ...
  Future sendOTP() async {
    try {
      var resSend = await http.post(Uri.parse(ipInfo + '/Beneficiary/login'),
  ...
  Future verifyOTP() async {
    try {
      var ress = await http.post(Uri.parse(ipInfo + '/Beneficiary/login/verify'),
          headers: <String, String>{
            'Context-Type': 'application/json;charSet=UTF-8'
          },
          body: {
      ...
      await storage.write(key: "benificiary", value: jsonDecode(ress.body)['result']);
      }
                          ...
                          children: [
                            TextButton(
                              ...
                              var snackBar = SnackBar(
                                ...
                                padding: EdgeInsets.only(bottom: 20,top: 20),content: Text('OTP resent to your email!',textAlign: TextAlign.center,style: TextStyle(fontSize: 18,),));
                               await ScaffoldMessenger.of(context).showSnackBar(snackBar);
                               Navigator.pop(context);
                            } catch (e) {
                              var snackBar = SnackBar(
                                backgroundColor: Colors.red.shade800,
                                padding: EdgeInsets.only(bottom: 20,top: 20),content: Text('Unable to sent the otp again',textAlign: TextAlign.center,style: TextStyle(fontSize: 18,),));
                            ...
                            Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  TextFormField(
                                    controller:
                                        TextEditingController(text: benificiary.benificiary_email),
                                    onChanged: (value) {

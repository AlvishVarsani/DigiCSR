...
class SignupScreenForNGO extends StatefulWidget {
  const SignupScreenForNGO({super.key});

  @override
  State<SignupScreenForNGO> createState() => _SignupScreenForNGOState();
}

class _SignupScreenForNGOState extends State<SignupScreenForNGO> {
  @override
              ...
              Container(
                ...
                decoration: const BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage("assets/images/ngopage.png"),
                      fit: BoxFit.cover),
                ),
              ),
              SizedBox(

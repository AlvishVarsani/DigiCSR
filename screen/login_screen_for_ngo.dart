...
class LoginScreenForNGO extends StatefulWidget {
  const LoginScreenForNGO({super.key});

  @override
  State<LoginScreenForNGO> createState() => _LoginScreenForNGOState();
}

class _LoginScreenForNGOState extends State<LoginScreenForNGO> {
    bool isCheck = false;
  @override

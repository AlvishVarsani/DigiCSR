...
class SignupScreenForUsers extends StatefulWidget {
  const SignupScreenForUsers({super.key});

  @override
  State<SignupScreenForUsers> createState() => _SignupScreenForUsersState();
}

class _SignupScreenForUsersState extends State<SignupScreenForUsers> {
  @override
